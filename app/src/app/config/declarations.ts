...
export const appRoutes = [{path: 'list', component: listComponent},{path: 'todo', component: todoComponent},{path: 'home', component: addareaComponent},{path: '', redirectTo: '/todo', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
